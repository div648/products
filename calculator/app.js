...
} else if (mode == "Сколько % составляет число _ от числа _") {
...
} else if (mode == "К числу _ прибавить _ %") {
...
} else if (mode == "От числа _ отнять _ %") {
...
} else if (mode == "Число _ умножить на _ %") {
...
} else if (mode == "Число _ поделить на _ %") {
